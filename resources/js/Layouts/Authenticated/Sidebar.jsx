                        ...
                        <div>
                            ...
                            >
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    className={`text-black ${isActive('/auth/dashboard') ? 'text-yellow-500' : 'group-hover:text-yellow-500'}`}
                            ...
                            >
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    className={`text-black ${isActive('#!') ? 'text-yellow-500' : 'group-hover:text-yellow-500'}`}
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                                    <path
                                        fillRule="evenodd"
                            ...
                            <Link
                                href="#!"
                                className={`side-link group mb-0 flex items-center gap-[10px] rounded-lg px-6 py-2 transition-all ${
                                    isActive('#!')
                                        ? 'bg-softpur text-yellow-500'
                                        : 'hover:bg-softpur'
                                }`}
                        ...
                        <div className="mt-auto pr-[30px]">
                            <div className="rounded-[25px] bg-black p-5 text-white">
                                <img
                                    ...
                                    className="h-12 w-12"
                                />
                                <div className="mb-8 mt-4 text-lg font-semibold">
                                    For Greatest
                                </div>
                                ...
                                <div className="h-[6px] w-full overflow-hidden rounded-full bg-[#333333]">
                                    <div className="h-full w-9/12 rounded-full bg-yellow-500 transition-all"></div>
                                </div>
                            </div>
                        </div>
                    </div>
